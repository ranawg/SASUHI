...
def mosaic_collections_by_date(ic1, ic2):
    """Merges and mosaics two image collections by date."""
    ...
    def mosaic_on_date(t):
        ...
        return daily_images.mosaic().set('system:time_start', t.millis())
...
def get_image_dates(collection, max_images):
...
def get_chunked_stack(image_collection, region, scale, band_names, chunk_size=40, sleep_time=3):
    ...
    for i in range(num_chunks):
        ...
        try:
            dates_chunk = get_image_dates(chunk_ic, chunk_size)
